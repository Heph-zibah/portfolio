    ...
    <header class=" px-5 lg:px-14 py-2 w-full absolute top-0 " >
        <nav class="flex items-center justify-between max-w-[1200px] mx-auto">
            ...
            <div class="flex items-center gap-3 lg:gap-5">
                ...
                <router-link :to="{name: 'contact'}"  class="rounded-full bg-[#FFD7A8] dark:bg-[#FF7A59] text-[#3E3A33] dark:text-[#1E1E1E] hover:bg-[#F4A7A3] dark:hover:bg-[#FF5722] hover:text-[#FFFFFF] dark:hover:text-[#FFFFFF] py-2.5 lg:py-3 px-5 text-nowrap md:px-10  font-semibold" :class="isDark? 'border border-[#3A3A3A]' : 'border border-[#E0E0E0]'">
                    Hire me
                </router-link>
